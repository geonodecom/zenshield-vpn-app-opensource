...
@protocol LibboxPingAllResultCallback;
@class LibboxPingAllResultCallback;
...
@protocol LibboxTcpPingResultCallback;
@class LibboxTcpPingResultCallback;
...
@protocol LibboxPingAllResultCallback <NSObject>
...
@protocol LibboxTcpPingResultCallback <NSObject>
- (void)onResult:(NSString* _Nullable)result;
@end
...
@interface LibboxServerPingResult : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) _Nonnull id _ref;
...
@interface LibboxTcpPingResultExportWrapper : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) _Nonnull id _ref;

- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nullable instancetype)init:(id<LibboxTcpPingResultCallback> _Nullable)cb;
- (void)checkTcpPingForLinks:(NSString* _Nullable)links;
@end
...
FOUNDATION_EXPORT const int32_t LibboxCommandTcpPing;
...
FOUNDATION_EXPORT NSString* _Nonnull LibboxGetFullConfigFromGatewayResponse(NSString* _Nullable config, NSError* _Nullable* _Nullable error);

FOUNDATION_EXPORT NSString* _Nonnull LibboxGetFullConfigFromGatewayResponseWithPolicy(NSString* _Nullable config, NSString* _Nullable policy, NSError* _Nullable* _Nullable error);

FOUNDATION_EXPORT NSString* _Nonnull LibboxGetGroupDelay(NSString* _Nullable groupName, NSString* _Nullable url, NSString* _Nullable bearer, long port);
...
FOUNDATION_EXPORT LibboxTcpPingResultExportWrapper* _Nullable LibboxNewTcpPingResultExportWrapper(id<LibboxTcpPingResultCallback> _Nullable cb);

FOUNDATION_EXPORT LibboxWIFIState* _Nullable LibboxNewWIFIState(NSString* _Nullable wifiSSID, NSString* _Nullable wifiBSSID);

FOUNDATION_EXPORT void LibboxPingAllServers(NSString* _Nullable groupNames, NSString* _Nullable probeUrl, NSString* _Nullable links, NSString* _Nullable bearer, long port, id<LibboxPingAllResultCallback> _Nullable callback);

FOUNDATION_EXPORT void LibboxPingAllServersBackground(NSString* _Nullable linksJson, NSString* _Nullable probeUrl, id<LibboxPingAllResultCallback> _Nullable callback);
...
@interface LibboxPingAllResultCallback : NSObject <goSeqRefInterface, LibboxPingAllResultCallback> {
}
@property(strong, readonly) _Nonnull id _ref;
...
@interface LibboxTcpPingResultCallback : NSObject <goSeqRefInterface, LibboxTcpPingResultCallback> {
}
@property(strong, readonly) _Nonnull id _ref;
